...
public class Ball : MonoBehaviour
{
    ...
    private void InitializeBall()
    {
        ...
        // Ensure we have a CircleCollider2D
    ...
    private void Update()
    {
        // Launch ball with space key
        if (!gameStarted && Input.GetKeyDown(KeyCode.Space))
        {
            LaunchBall();
        }

        if (gameStarted && rb != null)
        {
    ...
    public void ResetBall()
    {
        ...
        if (rb != null)
        {
            ...
            transform.position = new Vector3(0, -3f, 0); // Position above paddle
        }
        Debug.Log("Ball reset - Press SPACE to launch!");
    }
